    ...
    >
      ...
      {isPlainObject(voiceMetrics) || voiceCoaching.length > 0 ? (
        <section style={{ ...card(), marginBottom: 20 }}>
          <div style={sectionHeader("linear-gradient(90deg,#6366F1,#8B5CF6)")}>
            <span style={iconBadge("linear-gradient(135deg,#6366F1,#8B5CF6)")}>
              🎤
            </span>
            음성 분석
          </div>
        ...
        <section style={{ ...card(), marginBottom: 20 }}>
          ...
          <EmptyBlock
            ...
            desc="누락: voiceMetrics / voiceCoaching"
          />
        </section>
      )}
      ...
      {isPlainObject(stt) ? (
        <section style={{ ...card(), marginBottom: 20 }}>
          <div style={sectionHeader("linear-gradient(90deg,#0EA5E9,#3B82F6)")}>
            <span style={iconBadge("linear-gradient(135deg,#0EA5E9,#3B82F6)")}>
              📝
            </span>
            STT 분석
          </div>
      ...
      <section style={card()}>
        <div style={sectionHeader("linear-gradient(90deg,#F59E0B,#EF4444)")}>
          <span style={iconBadge("linear-gradient(135deg,#F59E0B,#EF4444)")}>
            📋
          </span>
          질문별 답변 분석
        </div>
