    ...
    <div className="competency-card">
      ...
      <div className="competency-score">
        ...
        <div className="score-bar">
          <div className="score-progress target"  style={{ width: `${target}%` }} />
          <div className="score-progress current" style={{ width: `${current}%` }} />
        </div>
      </div>
  ...
  return (
    <div className="tab-content">
      ...
      <div className="competency-overview">
        <CompetencyBlock title="💻 기술 역량"  data={comp?.technical} labelMap={TECH_LABELS} />
        <CompetencyBlock title="🤝 소프트 스킬" data={comp?.soft}      labelMap={SOFT_LABELS} />
      </div>
